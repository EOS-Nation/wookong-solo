...
//struct
const { PAEW_CALLBACK_DATA_MAX_LEN } = DLLCONST;
const { PAEW_DEV_INFO_SN_LEN } = DLLDEVINFO.SN;
const { PAEW_DEV_INFO_COS_VERSION_LEN } = DLLDEVINFO.COSVERSION;
const { PAEW_DEV_INFO_SESSKEY_HASH_LEN } = DLLDEVINFO.SESSKEYHASH;
